...
$strSQL = "SELECT * FROM $table where dt_plantao >= '$hoje' and setor like '%Telecom%' order by dt_plantao,hora_ent, hora_ent ASC";
...
echo "<table class='table table-hover table-bordered'>
		 <caption><h1>Escala Telecom</h1></caption>
		 <thead>
			<tr>
				<th>Nome</th>
				<th>Celular</th>
...
while ( $row = mysql_fetch_array ( $rs ) ) {
	...
	echo "<td>$row[nome]</td>
					...
					<td>";
	?>
					<span class="action name btn"><a href="#" id="<?php echo $id1; ?>"
			class="delete" title="Deletar"><i class='icon-trash'></i></a></span>

		<a class='btn' title='Editar'
			href='javascript:SubmitForm(<?php echo $row['id']; ?>)'> <i
