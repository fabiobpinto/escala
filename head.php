...
$strSQL = "SELECT * FROM $table where dt_plantao = '$hoje' and setor like '%Head%' order by hora_ent, nome ASC";
...
echo "<table class='table table-hover table-bordered espace'>
		 <caption><h3>Escala Head End</h3></caption>
		 <thead>
			<tr>
				<th>Nome</th>
				<th>Celular</th>
...
?> 
	...
	function CountDown(){
	    ...
	    if(counter > 0){
			...
			window.location = "head.php"; //URL DA PAGINA A SER REDIRECIONADA
		}
	}
